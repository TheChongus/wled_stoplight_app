...
def update_start_end():
    start_time = input("Please enter the start time (in 24h format, e.g., 08:00 for 8am): ")
    end_time = input("Please enter the end time (in 24h format, e.g., 23:00 for 11pm): ")
...
def main():
    ...
    print("\n This script is designed to run each day from defined start and end time. The default start time is 06:00 and the default end time is 23:59. Would you like to change these values? (y/n)")
